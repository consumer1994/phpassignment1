      ...
      <div class="pageContainer centerText">
         ...
         <form method="get" action="ValidateConfirm.php" autocomplete="on" class="formLayout">
            ...
            <div class="formGroup">
               ...
               <input type="text" name="lname" class="textbox" autofocus required  
           ...
           <div class="formGroup">
               ...
               <input type="text" name="phone"class="textbox"  style="width:100px;" required 
            ...
            <div class="formGroup">
               ...
               <input type="text" name="zip" class="textbox" style="width:100px;" required 
                      placeholder="Zip" title="6-digit zip" maxlength="6" pattern="[0-9]{6}" />
            </div>
            <div class="formGroup">
               <label></label>
